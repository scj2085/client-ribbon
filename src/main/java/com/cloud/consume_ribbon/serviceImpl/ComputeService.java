...
public class ComputeService {
    ...
    @HystrixCommand(fallbackMethod = "addServiceFallback",commandKey = "comkey")//@HystrixCommand用于依赖服务返回单个操作结果的时候
//    @HystrixCommand(fallbackMethod = "addServiceFallback",commandKey = "comkey",commandProperties = {@HystrixProperty(name = "execution.isolation.thread.timeoutInMilliseconds",value = "8000")})//@HystrixCommand用于依赖服务返回单个操作结果的时候
